...
const Trending = ({ trendingPosts }: Props) => {
  return (
    <section className="pt-3 pb-10">
      ...
      <p className="text-sm">
        Indulge in a journey of knowledge and inspiration with our
        thought-provoking content that goes beyond the ordinary - because we
        believe in shaping the future through continuous learning and
        exploration.
      </p>
    </section>
  );
